angular.module('starter.controllers', [])
                        ...
                        if ($rootScope.online === true) {
                            ...
                            services.loginUser(username, passwordSha1).then(function mySuccess(response) {
                                ...
                                if (response["tns:custid"] == null) {
                                    $ionicLoading.hide();
                                    $cordovaToast.showShortCenter('Enter valid credentials').then(function (success) {// success
                    ...
                    if ($rootScope.online === true) {
                        services.registration(userEmail).then(function mySuccess(response) {
                            ...
                            if (response.result === "User Created Successfully") {
                                ...
                                $cordovaToast.showShortCenter(response.result).then(function (success) {// success
                                }, function (error) {// error
                                });
                            }
                        }, function myError(response) {
        ...
        .controller('passwordCtrl', function ($scope, $rootScope, $state, $location, services, $cordovaToast, $cordovaDialogs, $ionicLoading) {
            try {
                $scope.signInNavigation = function () {
                    $location.path('/sign-in');
                };
        ...
        .controller('HomeCtrl', function ($scope, services, $state, $http, $cordovaDialogs, $rootScope, $location, $window, $cordovaSQLite, $ionicLoading, $cordovaToast) {
            try {
                $scope.$on('$ionicView.enter', function () {
        ...
        .controller('tabsCtrl', function ($scope, $rootScope, $state, $location, $window, services, $cordovaToast, $cordovaDialogs) {})
...
//                  $rootScope.orderInstructionEmail = "";
                                                                ...
                                                                if (info) {
                                                                    services.deliveryInstruction(JSON.parse(orderDocumentOrderNoInvoiceetc), info.orderInstruction, info.orderInstructionEmail).then(function mySuccess(response) {
                                                                        ...
                                                                        $rootScope.httpErrorReport(data, status, headers, config);
...
//            }
        ...
        .controller('InvoicesCtrl', function ($scope, $location, $window, services, $cordovaToast, $cordovaDialogs, $ionicLoading, $rootScope, $cordovaSQLite) {
            try {
                $scope.$on('$ionicView.enter', function () {
...
// error
        ...
        .controller('EtaCtrl', function ($scope, services, $location, $window, $ionicLoading, $cordovaDialogs, $cordovaSQLite, $rootScope, $cordovaToast) {
            try {
                $scope.$on('$ionicView.enter', function () {
                    $scope.orderInvoice = "";
                });
...
// error
        ...
        .controller('SdsCtrl', function ($scope, $state, $http, $location, $window, $rootScope, $cordovaToast, $cordovaSQLite, $cordovaDialogs) {
            try {
                $scope.$on('$ionicView.enter', function () {
                });
...
// error
        ...
        .controller('invoiceCtrl', function ($scope, $state, services, $window, $ionicLoading, $cordovaDialogs, $location, $rootScope, $cordovaSQLite, $cordovaToast) {
            try {
                $scope.$on('$ionicView.enter', function () {
                    if ($rootScope.online === true) {
                        $ionicLoading.show({
        ...
        .controller('index', function ($scope, $state, $location, $cordovaToast, $cordovaDialogs) {
            try {
                $scope.$on('$ionicView.enter', function () {
